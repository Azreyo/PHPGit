...
function rvTreeToggle(el, e) {
    ...
    if (caret) {
        caret.className = isOpen ? 'bi bi-caret-down-fill' : 'bi bi-caret-right-fill';
    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    codeCells.forEach(function (cell, i) {
        cell.innerHTML = highlightedLines[i] !== undefined ? highlightedLines[i] : '';
    });
});
...
(function () {
    ...
    if (t === 'light') {
        el.href = 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.11.1/styles/github.min.css';
    }
})();
